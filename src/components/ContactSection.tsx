  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'reyanson4222@gmail.com',
      href: 'mailto:reyanson4222@gmail.com'
    },
    {
      icon: Phone,
      label: 'Phone',
      value: '+(94)76 378 7940',
      href: 'tel:+94763787940'
    },
    {
      icon: MapPin,
      label: 'Location',
      value: 'Vankalai, Mannar',
      href: '#'
    }
  ]

  const socialLinks = [
    { icon: Github, href: 'https://github.com/reyanson', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/reyanson-sosai/', label: 'LinkedIn' },
    { icon: Twitter, href: '#', label: 'Twitter' },
    { icon: Mail, href: 'mailto:reyanson4222@gmail.com', label: 'Email' }
  ]
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <p className="text-gray-400">
            © 2025 Reyanson Sosai. Designed &amp; Built with ❤️ using React and Tailwind CSS.
          </p>
        </motion.div>
      </div>
    </section>
