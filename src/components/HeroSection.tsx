    ...
    <section id="home" className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          >
            I craft exceptional digital experiences using cutting-edge technologies like Angular, React, Svelt, Laravel, Node.js, and TypeScript. 
          ...
          >
            ...
            <div className="flex items-center space-x-4">
              {[
                { icon: Github, href: 'https://github.com/reyanson' },
                { icon: Linkedin, href: 'https://www.linkedin.com/in/reyanson-sosai/' },
                { icon: Mail, href: 'mailto:reyanson4222@gmail.com' }
